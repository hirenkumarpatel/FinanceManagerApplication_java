<%-- 
    ...
    Created on : 30-Jul-2015, 1:16:49 PM
    Author     : Hiren Patel
--%>
                ...
                <div class="row">
                                ...
                                <%
                                    ...
                                    if (userEmail.isEmpty()) {
                                        ...
                                        try {
                                            ...
                                            while (result.next()) {
                                %>
                                <a href="view-category-detail.jsp?category=<%=result.getInt(1)%>" class="list-group-item ">
                                    <%= result.getString(2)%>
                                </a>
                                <%
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="well bs-component">
                            <form class="form-horizontal" method="post" action="NewCategory">
                                <fieldset>
                                    <legend>New Category</legend>
                                    <div class="form-group">
                                        <label for="txtCategoryName" class="col-lg-4 control-label">Category Name</label>
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="txtCategoryName" placeholder="Category Name" name="txtCategoryName">
                                        </div>
                                    </div>
