...
public class NewCategory extends HttpServlet {
    ...
    public void newCategory(HttpServletRequest request, HttpServletResponse response) throws IOException {
        String categoryName;
        String userEmail;
        ...
        if (categoryName.isEmpty() || userEmail.isEmpty()) {
            response.sendRedirect("new-category.jsp?error=please enter category name");
        } else {
            ...
            try {
                ...
                String query = "insert into categories(category_name,user_email) values (?,?)";
                ...
                response.sendRedirect("new-category.jsp?success=New Category successfully inserted.");
